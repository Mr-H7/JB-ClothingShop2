...
export default function Cart() {
  ...
  const L = lang === 'FR' ? {
    ...
    emptySub: 'Ajoutez des pièces depuis la boutique pour composer votre sélection.',
    ...
    emptySub: 'Add pieces from the boutique to build your selection.',
      ...
      <div className="container-luxury py-12">
        ...
        {items.length === 0 ? (
          <div className="luxury-card p-14 text-center max-w-lg mx-auto">
            ...
            <p className="text-[#5a5a5a] text-sm">{L.emptySub}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-4">
              {items.map(item => (
                <div key={item.key} className="luxury-card p-5 flex gap-5 flex-col sm:flex-row">
                  <div
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-[#4a4a4a] text-[0.65rem] tracking-wide mt-1">
                        {L.itemTotal}: <span className="text-white">{money(item.price * item.quantity)}</span>
                      </p>
                    </div>
                    <div className="flex items-center justify-between mt-3 gap-3 flex-wrap">
                      <div className="flex items-center border border-[#2a2a2a] w-fit">
                        <button
                          ...
                          className="w-9 h-9 flex items-center justify-center text-[#5a5a5a] hover:text-gold border-r border-[#2a2a2a] text-lg disabled:opacity-40 disabled:cursor-not-allowed"
                          aria-label="-"
