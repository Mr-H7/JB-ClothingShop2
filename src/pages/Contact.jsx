...
const contactDetails = [
  {
    ...
    sub: 'Mon–Sat: 10am – 7pm · Sun: 12pm – 5pm',
    icon: (
...
const faqs = [
  {
    ...
    a: 'Yes — we offer complimentary private styling consultations at our Mayfair flagship by appointment. Contact us to arrange your session.',
  },
  {
    q: 'What are your delivery options?',
    a: 'We offer express (next day) and standard (3–5 days) delivery across the UK. International shipping is available to 38 countries.',
  },
  {
    q: 'How do I return or exchange an item?',
    a: 'We accept returns within 14 days of delivery for unworn items with original tags. Exchanges are processed within 5 business days.',
  },
  {
    q: 'Do you offer gift wrapping?',
    a: 'All JB Clothing orders arrive in our signature black and gold packaging. Complimentary gift messaging is available at checkout.',
  },
]
...
export default function Contact() {
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen">
        ...
        <div className="container-luxury relative z-10 text-center">
          <div className="animate-fade-up">
            <div className="flex items-center justify-center gap-5 mb-5">
              ...
              <p className="label-gold tracking-[0.35em]">Get in Touch</p>
            ...
            <p className="text-[#5a5a5a] font-light max-w-md mx-auto text-sm md:text-base leading-relaxed">
              Our team is available to assist you with enquiries, styling advice, and bespoke requests.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container-luxury py-14">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              ...
              <h2 className="font-serif text-2xl md:text-3xl text-white">Join the JB Inner Circle</h2>
              <p className="text-[#4a4a4a] text-sm font-light mt-2">
                First access to new collections, private events, and editorial stories.
              </p>
            </div>
      ...
      <section className="section-luxury">
        <div className="container-luxury">
          <div className="text-center mb-16">
            <p className="label-gold mb-3">Direct Enquiry</p>
            <h2 className="heading-luxury text-4xl md:text-5xl text-white">Send Us a Message</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              {submitted ? (
                <div className="luxury-card p-14 text-center border-gold/25 h-full flex flex-col items-center justify-center">
                  ...
                  <h3 className="font-serif text-xl text-white mb-3">Message Sent</h3>
                  <p className="text-[#5a5a5a] text-sm font-light max-w-xs mx-auto leading-relaxed">
                ...
                <form
                  ...
                  className="luxury-card p-8 md:p-10 space-y-5 h-full"
                >
                  {/* Email */}
                  <div>
                  ...
                  {/* Message */}
                  <div>
                    <label className="label-gold block mb-2">Message <span className="text-gold/50">*</span></label>
                    <textarea
                      name="message"
                      required
                      rows={6}
                  ...
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <button type="submit" className="btn-gold-solid px-8">
                      Send Message
                    </button>
                  </div>
                </form>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="luxury-card overflow-hidden flex-1" style={{ minHeight: '400px' }}>
                ...
                <div className="border-b border-[#2a2a2a] px-6 py-4 flex items-center justify-between bg-[#111111]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="label-gold text-[0.55rem]">Our Flagship</p>
                  ...
                  <a
                    ...
                    className="text-[#4a4a4a] hover:text-gold transition-colors text-[0.6rem] tracking-widest uppercase"
                  >
                    Open Maps ↗
                  </a>
                </div>
                ...
                <div className="relative" style={{ height: 'calc(100% - 60px)', minHeight: '340px' }}>
                  {/* Dark overlay on map to match luxury aesthetic */}
                  <div
                  ...
                  />
                  <iframe
                    title="JB Clothing Location — Savile Row, Mayfair, London"
              ...
              <div className="luxury-card p-6">
                <p className="label-gold mb-4">Store Hours</p>
        ...
        <div className="container-luxury">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-14">
              <p className="label-gold mb-3">Common Enquiries</p>
              <h2 className="heading-luxury text-4xl text-white">Frequently Asked</h2>
              <GoldDivider variant="ornament" />
            </div>
            ...
            <div className="space-y-2">
              {faqs.map((faq, i) => (
                <div
                  key={i}
                  className={`luxury-card overflow-hidden transition-all duration-400 ${
                    openFaq === i ? 'border-gold/30' : ''
                  }`}
                >
                  <button
      ...
      >
        {/* Tooltip */}
        <span className="absolute right-14 top-1/2 -translate-y-1/2 bg-[#111111] border border-[#2a2a2a] text-white text-xs px-4 py-2 rounded-full whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
          Chat on WhatsApp
        ...
        {/* Button */}
        <div className="w-14 h-14 rounded-full flex items-center justify-center shadow-[0_4px_24px_rgba(0,0,0,0.5)] transition-all duration-300 group-hover:scale-110"
